...
public class UnsupportedAIModelException extends ApplicationException {

    public UnsupportedAIModelException(AIModelType modelType) {
        super(HttpStatus.BAD_REQUEST, "Unsupported AI model: " + modelType);
    }
}
